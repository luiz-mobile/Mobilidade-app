...
public class RateActivity extends AppCompatActivity {
    ...
    private void submitRateDetails() {
        ...
        rateDetailRef.child(Common.driverID)
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        driverInformationRef.child(Common.driverID)
                                                ...
                                                .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        alertDialog.dismiss();
                                                        Toast.makeText(getApplicationContext(), "Obrigado por enviar", Toast.LENGTH_SHORT).show();
                                                        finish();
                                                    }
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                alertDialog.dismiss();
                                                Toast.makeText(getApplicationContext(), "Taxa atualizada, mas não é possível gravar nas informações do driver", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    }
                                    @Override
            ...
            public void onFailure(@NonNull Exception e) {
                alertDialog.dismiss();
                Toast.makeText(getApplicationContext(), "Taxa falhou!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
