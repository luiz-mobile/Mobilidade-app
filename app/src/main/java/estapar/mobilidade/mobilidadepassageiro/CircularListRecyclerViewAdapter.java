...
public class CircularListRecyclerViewAdapter extends RecyclerView.Adapter<CircularListRecyclerViewAdapter.ViewHolder> {
    ...
    private CircularListFragment.OnCircularListFragmentInteractionListener mListener;
    ...
    public void setmListener(CircularListFragment.OnCircularListFragmentInteractionListener listener) {
        mListener = listener;
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public final CircularListFragment.OnCircularListFragmentInteractionListener mListener;
        public Circular mItem;
        public String mCircularName;

        public ViewHolder(View view, CircularListFragment.OnCircularListFragmentInteractionListener listener ) {
            super(view);
            mView = view;
            mListener = listener;
